...
<div class="row mb-4">
    ...
    <div class="col-md">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="needs-validation" action="{{ route('newSignUp') }}" method="POST"
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="select2-success">
                                    <div class="position-relative">
                                        <select id="select2Success" name="package_id"
                                            class="select2 form-select select2-hidden-accessible"
                                            data-select2-id="select2Success" tabindex="-1" aria-hidden="true">
                                            <option value="">Select Package</option>
                                            @foreach ($packages as $package)
                                            <option class="package" value="{{ $package->id }}">{{ $package->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
    ...
    $('#select2Success').on('change',function(){
        ...
        console.log(id);
           ...
           $.ajax({
            ...
            url:'{{ route('package-price') }}',
            success: function(response){
                    console.log(response);
                    let packagePrice = ` <label class="switch switch-square perMonth">
                                            ...
                                            <span class="switch-label">${response.packagePrice.price_monthly} Per Month </span>
                                        </label>
                                        <label class="switch switch-square">
                                            ...
                                            <span class="switch-label">${response.packagePrice.price_year} Per Year</span>
                                        </label>
                                        `;
                    $('.switches-stacked').append(packagePrice);
            }
