            ...
            <tbody class="table-border-bottom-0" id="myTable">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {{-- Modale Update Status --}}
                        @elseif($car->status == 1)
                        <a class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalTop{{ $car->id }}"
                            href="">
                            <strong>
                                السيارة متوفرة
                            </strong>
...
$(document).ready(function(){
        // $('#basic-default-car').on('change',function(){
        //         console.log('Changed');
        //         status = $('basic-default-car').val();
        //         console.log(status);
        // });
        $(".sel-CarState").change(()=>{
            ...
            $.ajax({
                    ...
                    success:function(response){
                        ...
                        //         @if($car->status == 0)
                        //         <a class="btn btn-danger text-black" data-bs-toggle="modal" data-bs-target="#modalTop{{ $car->id }}">
                        //             <strong>
                        //                 السيارة معطلة
                        //             </strong>
                        //         </a>
                        ...
                        //         {{-- Modale Update Status --}}
                        //         @elseif($car->status == 1)
                        //         <a class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalTop{{ $car->id }}" href="">
                        //             <strong>
                        //                 السيارة متوفرة
                        //             </strong>
                        //         </a>
                        ...
                        //         {{-- Modale Update Status --}}
                        //         @elseif($car->status == 2)
                        //         <a class="btn btn-warning text-black" data-bs-toggle="modal" data-bs-target="#modalTop{{ $car->id }}">
                        //             <strong>
                        //                 السيارة في الطريق
                        //             </strong>
                        ...
                        //     <td>
                        //         <div style="display: flex;align-items: center;justify-content: space-between;">
                        //             <i class="fa-solid fa-ellipsis-vertical btnCus" style="cursor: pointer" id="btn{{ $car->id }}"></i>
                        
                        //             <div class="d-none menu-cus"
                        //                 style="position: absolute;left: -1%;background: #aaa;color: #e9ecee;padding: 10px;border-radius: 8px;margin-top: 45px;">
                        //                 <a style="font-weight: 600;" class="dropdown-item" data-bs-target="#basicModal{{ $car->id }}"
                        //                     data-bs-toggle="modal" href="javascript:void(0);"><i class="bx bx-edit-alt me-1"></i>
                        //                     Edit</a>
                        //                 <a style="font-weight: 600;" class="dropdown-item"
                        //                     href="{{ route('deleteCar', ['id' => $car->id]) }}"><i class="bx bx-trash me-1"></i>Delete</a>
                        //             </div>
                        //         </div>
                        //     </td>
                        // </tr>`;
