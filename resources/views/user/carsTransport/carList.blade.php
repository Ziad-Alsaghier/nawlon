                                ...
                                @if ($car->status == 0)
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <!-- Modal -->
                                            <div class="modal modal-top fade" id="modalTop{{ $car->id }}"
                                                tabindex="-1">
                                                    ...
                                                    <div class="card-body">
                                                        <form class="needs-validation" action="{{ route('updateCar') }}"
                                                            ...
                                                            <div class="mb-3 " id="inputMonthly">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label"
                                                                        for="basic-default-upload-file">
                                                                        تعديل صورة السيارة
                                                                    </label>
                                                                    <input type="file" name="image"
                                                                        value="{{ $car->image }}" class="form-control"
                                    ...
                                    <form class="browser-default-validation" action="{{ route('processAddCar') }}"
                                        ...
                                        <div class="mb-3 form-password-toggle">
                                            ...
                                            <div class="input-group input-group-merge">
                                                <input type="text" id="basic-default-name" name="brand"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="car_number"
