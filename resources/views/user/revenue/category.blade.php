...
<div class="card">
    <h5 class="card-header">جميع الأصناف</h5>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="dropdown-item" data-bs-target="#basicModal{{ $category->id}}" data-bs-toggle="modal"
                            ...
                            Edit</a>
                        <a class="dropdown-item" href="{{ route('deleteCategoryRevinue',['id'=>$category->id]) }}"><i
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md">
                                        ...
                                        <div class="card">
                                            <h5 class="card-header">التعديل في صنف الايرادات : {{ $category->cars_name
                                                }}</h5>
                                            <div class="card-body">
                                                <form class="needs-validation"
                                                    action="{{ route('editCategoryRevinue') }}" method="POST"
...
<div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1"> الاصناف</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md">
                        ...
                        <div class="card">
                            <h5 class="card-header"> اضافة الصنف </h5>
                            <div class="card-body">
                                <form class="browser-default-validation" action="{{ route('addRevinue') }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name"
                                            placeholder="اكتب اسم الصنف للايرادات " />
                                        @error('name')
                                        <span>{{ $message }}</span>
                                        @enderror
                                    </div>
