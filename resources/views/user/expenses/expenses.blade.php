        ...
        <table class="table">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    ...
                    <td>
                        <strong>
                            {{$expense->category_expenses->name}}
                        </strong>
                    </td>
                    <td>
                        <strong>
                    ...
                    <td>
                        ...
                        <a class="dropdown-item" data-bs-target="#basicModal{{ $expense->id}}" data-bs-toggle="modal"
                            href="javascript:void(0);"><i class="bx bx-edit-alt me-1"></i>
                            Edit</a>
                        <a class="dropdown-item" href="{{ route('deleteExpenses',['id'=>$expense->id]) }}"><i
                                class="bx bx-trash me-1"></i>
                            Delete</a>
                    </td>
                </tr>
                {{-- Start Model With Eit Car --}}
                <div class="modal fade" id="basicModal{{ $expense->id}}" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel1">{{ $expense->id}} title</h5>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md">
                                        ...
                                        <div class="card">
                                            <h5 class="card-header">التعديل في المصروف : {{ $expense->name
                                                }}</h5>
                                            <div class="card-body">
                                                <form class="browser-default-validation"
                                                    action="{{ route('editExpenses') }}" method="POST"
                                                    enctype="multipart/form-data">
                                                    @csrf
                                                    <input type="hidden" name="expenses_id" value="{{ $expense->id }}">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="name">اسم المصروف</label>
                                                        <input type="text" value="{{ $expense->name }}" name="name"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="total_price" class="form-control"
                                                            id="total_price" value="{{ $expense->total_price }}"
                                                            placeholder="اكتب اسم المصروف " />
                                                        @error('total_price')
                                                        <span>{{ $message }}</span>
                                                        @enderror
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" id="basic-default-country"
                                                            name="category_expenses_id">
                                                            <option value="{{ $expense->category_expenses_id }}">اختار
                                                                صنف المصروف
                                                            </option>
                                                            @foreach($categoryExpenses as $categoryExpense)
                                                            <option value="{{ $categoryExpense->id }}">{{
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md">
                        ...
                        <div class="card">
                            <h5 class="card-header">اضافة المصروفات </h5>
                            <div class="card-body">
                                <form class="browser-default-validation" action="{{ route('proccessAddCategory') }}"
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="total_price"> المبلغ المدفوع</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="basic-default-country"
                                            ...
                                            @foreach($categoryExpenses as $categoryExpense)
                                            <option value="{{ $categoryExpense->id }}">{{ $categoryExpense->name }}
                                            </option>
