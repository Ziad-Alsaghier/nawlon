...
<div class="card">
    <h5 class="card-header">جميع الموردين</h5>
    <div class="table-responsive text-nowrap">
        <table class="table">
            <thead class="table-dark">
                <tr>
                    <th>اسم المورد</th>
                    <th> رقم موبايل المورد</th>
                    <th>عنوان المورد</th>
                    <th>تعديلات</th>
                </tr>
            </thead>
            <tbody class="table-border-bottom-0">
                @foreach ($supllires as $supplier)
                <tr>
                    <td>
                    ...
                    <td>
                        <div style="display: flex;align-items: center;justify-content: space-between;">
                            <i class="fa-solid fa-ellipsis-vertical btnCus" style="cursor: pointer"
                                id="btn{{ $supplier->id }}"></i>

                            <div class="d-none menu-cus"
                                style="position: absolute;left: 9%;background: #aaa;color: #e9ecee;padding: 10px;border-radius: 8px;">
                                <a style="font-weight: 600;" class="dropdown-item"
                                    data-bs-target="#basicModal{{ $supplier->id }}" data-bs-toggle="modal"
                                    href="javascript:void(0);"><i class="bx bx-edit-alt me-1"></i>
                                    Edit</a>
                                <a style="font-weight: 600;" class="dropdown-item"
                                    href="{{ route('deleteSupplier', ['id' => $supplier->id]) }}"><i
                ...
                <div class="modal fade" id="basicModal{{ $supplier->id }}" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <h5 class="card-header"> تعديل المورد :{{ $supplier->name }}</h5>
                                <div class="card-body">
                                    <form class="browser-default-validation" action="{{ route('supplierUpdate') }}"
                                        method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="supplier_id" value="{{ $supplier->id }}">
                                        <div class="mb-3">
                                            <label class="form-label" for="name">الاسم </label>
                                            <input type="text" value="{{ $supplier->name }}" name="name" id="name"
                                        ...
                                        <div class="mb-3 form-password-toggle">
                                            ...
                                            <div class="input-group input-group-merge">
                                                <input type="number" value="{{ $supplier->phone }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="browser-default-validation" action="{{ route('addSupplier') }}"
                                    method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mb-3 form-password-toggle">
                                        <label class="form-label" for="phone">رقم الموبيل </label>
                                        <div class="input-group input-group-merge">
                                            <input type="number" id="basic-default-name" name="phone"
                                                class="form-control" placeholder="اكتب  رقم المورد"
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="basic-default-dob">العنوان </label>
                                        <input type="text" name="address" placeholder="اكتب عنوان المورد"
                                            class="form-control flatpickr-validation" id="basic-default-dob" />
                                        @error('address')
                                        <span>{{ $message }}</span>
                                        @enderror
