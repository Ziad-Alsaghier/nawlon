...
<div class="mt-3">
    ...
    <div class="card">
        <h5 class="card-header">جميع الاقسام</h5>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="dropdown-item" data-bs-target="#basicModal" data-bs-toggle="modal"
                                ...
                                Edit</a>
                            <a class="dropdown-item" href="{{ route('deletedivide',['id'=>$divide->id]) }}"><i
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form class="browser-default-validation" action="{{route('editDivide')}}"
                                                method="POST" enctype="multipart/form-data" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <div class="mb-3">
                                                    <label class="form-label" for="name">اسم القسم</label>
                                                    <input type="text" value='{{ $divide->driv_name }}' name="name"
                                                        class="form-control" id="name" />
                                                    @error('name')
                                                    <span>{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                <input type="hidden" name="divide_id" value="{{$divide->id}}">
                                                <div class="row">
                                                    <div class="col-12">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <form class="browser-default-validation" action="{{route('divideAdd')}}" method="POST"
                            ...
                            <div class="input-group input-group-lg mb-3">
                                <input type="text" class="form-control bg-white border-0"
                                    placeholder="اكتب اسم القسم الجديد" aria-describedby="subscribe" name="name" />
