        ...
        <div data-repeater-item>
                    ...
                    <div class="lists_services">
                        ...
                        <div id="items_services">
                            ...
                            {{-- <div class="item_services">
                                ...
                                <input type="number" name="services_price" class="services_price"
                                    id="val_services_price" value="" placeholder="ادخل سعر المصنعية" required>
            ...
            <div class="d-none maintenances_price">
                ...
                <div class="servicess_price">
                    ...
                    <input type="text" name="servicess_total_price[]" id="servicess_total_price" value="0"
                        readonly />
                </div>
    ...
    <script>
        $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $(car).each((ele, val) => {
                                ...
                                var cars =
                                    `<option value='${ele}${val.cars_name}' id="car${ele}">${val.cars_name}</option>`;
                            ...
                            $("#add_sparePart").click(() => {
                                ...
                                if (car[ic].car_parts == "") {
                                    ...
                                    $(car[ic].car_parts).each((eleP, valP) => {
                                        ...
                                        var sparePartt =
                                            `<option value='${valP.code}_${valP.name}'>${valP.name}</option>`;
                                    ...
                                    var new_sparePart = `<div class="item_spare_part" style="padding-bottom: 10px;border-bottom: 2px solid #d6d6d6;">
                                            ...
                                            <label class="col-md-1 tex-price" for="val_spare_part_price${numI}">السعر:</label>
                                                <input type="text" class="spare_part_price col-md-10 mt-1" id="val_spare_part_price${numI}" value="0" placeholder="0" readonly>
                                                <span class="remove_item remove_spare_part" id="remove_spare_part${numI}">مسح</span>
                                                </div>`;
                                    numI++;
            ...
            $("#send_maintenice").click(() => {
                console.clear();
                var category_Name = $("#category").val().slice(1, $("#category").val().length);
