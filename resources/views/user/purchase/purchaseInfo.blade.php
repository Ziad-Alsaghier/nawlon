                    ...
                    <div class="card-body">
                        <div
                            ...
                            <div class="mb-xl-0 mb-4">
                                <strong>
                                    <img width="200px"
                                        src='{{ asset("public/images/customer/".auth()->user()->logoImage) }}' alt="">

                                </strong>

                            </div>
                            <div>
                                <h4>رقم &nbsp; #{{ $purchases->id }}</h4>
                                <div class="mb-2">
                                    <span class="me-1">تاريخ الشراء :</span>
                                    <span class="fw-semibold">{{ $purchases->created_at }}</span>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row p-sm-3 p-0">
                            <div class="col-xl-6 col-md-12 col-sm-5 col-12 mb-xl-0 mb-md-4 mb-sm-0 mb-4">
                                <h6 class="pb-2">تفاصيل : عملية الشراء</h6>
                                <p class="mb-1">اسم قطعة الغيار : {{ $purchases->carPart->name }}</p>
                                <p class="mb-1">مكان قطعة الغيار :{{ $purchases->carPart->location }} </p>
                                {{-- <p class="mb-1">رقم السيارة : {{ $purchases->car->car_number }}</p> --}}
                            </div>
                            <div class="col-xl-6 col-md-12 col-sm-7 col-12">
                                <table>
                                    <tbody>
                                        <tr>
                                            <td class="pe-3">تاريخ الشراء:</td>
                        ...
                        <table class="table border-top m-0">
                            <thead>
                                <tr>
                                    ...
                                    <th>اسم المورد</th>
                                    <th colspan="2">مكان قطعة الغيار</th>
                                    <th>سعر الشراء</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-nowrap">{{$purchases->carPart->name }}</td>
                                    <td class="text-nowrap">{{ $purchases->supplier->name }}</td>
                                    <td colspan="2">{{ $purchases->carPart->location }}</td>
