...
<div class="row mb-4">
  ...
  <div class="col-md">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form class="needs-validation" action="{{ route('newCustomer') }}" method="POST" enctype="multipart/form-data"
          novalidate="">
          @csrf
              ...
              <div class="col-md-6 mb-4">
                <div class="select2-success">
                  <div class="position-relative">
                    <select id="select2Success" name="package" class="select2 form-select select2-hidden-accessible"
                ...
                <div class="d-flex align-items-start align-items-sm-center gap-4">
                  ...
                  <div class="button-wrapper">
                    <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                      ...
                      <input type="file" name="logoImage" id="upload" class="account-file-input" hidden
