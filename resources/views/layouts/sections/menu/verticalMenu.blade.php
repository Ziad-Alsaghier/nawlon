...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <a href="{{ url('/') }}" class="app-brand-link">
            ...
            <form method="post" enctype="multipart/form-data" id="profile-setup">
                ...
                <div class='d-flex justify-content-center py-2' style="flex-direction: column;">
                    <label for="profile_image">
                        <img id="image-profile-prev" style="height: 130px; cursor: pointer; width: 200px;"
                            src="{{ asset('assets/img/transporter.png') }}" />
                    </label>
                    <input type="file" name="logoImage" class="form-control d-none" id="logoImage" />
                </div>
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item ">
            <a href="{{ route('affiliate-dashboard') }}" class="menu-link">
        ...
        <li class="menu-item ">
            ...
            <ul class="menu-sub">
                <a href="{{ route('new-signUp') }}" class="menu-link ">
                ...
                <a href="{{ route('add-affiliate') }}" class="menu-link ">
                    <i class="fa-solid fa-users mx-1"></i>
            ...
            <a href="{{ route('payout-affiliate') }}" class="menu-link ">
                <i class="fa-solid fa-money-bill-transfer"></i>
                &nbsp;
                <div>Payout</div>
            </a>
            <a href="{{ route('affiliate-help') }}" class="menu-link ms-2 ">
                        ...
                        <li class="menu-item">
                            ...
                            <ul class="menu-sub">
                                <a href="{{ route('add-affiliate') }}" class="menu-link ">
                                    ...
                                    <div>New Affiliate</div>
                                </a>
                                <a href="{{ route('list_affiliate') }}" class="menu-link ">
                                    <i class="fa-solid fa-users mx-1"></i>

                                    <div>List Of Affiliate</div>
                                </a>
                                ...
                                <ul class="menu-inner py-1">
                                    ...
                                    <li class="menu-item ">
                                        ...
                                        <a href="{{ route('login.destroy') }}" class="menu-link">
                                            <div>Log Out &nbsp; <i class="fa-solid fa-right-from-bracket"></i>
                                            </div>
                                        </a>
                                    </li>
                                    @endisset
