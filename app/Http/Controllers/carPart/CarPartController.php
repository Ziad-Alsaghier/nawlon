...
class CarPartController extends Controller
{
    ...
    protected $requesrCarPart = ['name','product_category_id','car_id','coverPhoto','image','code','location',
    ];
        ...
        $checkCarPart = CarPart::where('name','=', $request->name)->first();
                if($checkCarPart){
                session()->flash('faild','هذا الاسم موجود بالفعل');
